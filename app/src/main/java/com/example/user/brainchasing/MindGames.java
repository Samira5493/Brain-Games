...
public class MindGames extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //shuffle the images
        java.util.Collections.shuffle(java.util.Arrays.asList(cardsArray));

        tv_p2.setTextColor(android.graphics.Color.GRAY);

        iv_11.setOnClickListener(new android.view.View.OnClickListener() {
            @Override
        ...
        iv_12.setOnClickListener(new android.view.View.OnClickListener() {
            @Override
            public void onClick(android.view.View view) {
                int theCard = Integer.parseInt((String) view.getTag());
        ...
        iv_13.setOnClickListener(new android.view.View.OnClickListener() {
            @Override
            public void onClick(android.view.View view) {
                int theCard = Integer.parseInt((String) view.getTag());
        ...
        iv_14.setOnClickListener(new android.view.View.OnClickListener() {
            @Override
            public void onClick(android.view.View view) {
                int theCard = Integer.parseInt((String) view.getTag());
        ...
        iv_21.setOnClickListener(new android.view.View.OnClickListener() {
            @Override
            public void onClick(android.view.View view) {
                int theCard = Integer.parseInt((String) view.getTag());
        ...
        iv_22.setOnClickListener(new android.view.View.OnClickListener() {
            @Override
            public void onClick(android.view.View view) {
                int theCard = Integer.parseInt((String) view.getTag());
        ...
        iv_23.setOnClickListener(new android.view.View.OnClickListener() {
            @Override
            public void onClick(android.view.View view) {
                int theCard = Integer.parseInt((String) view.getTag());
        ...
        iv_24.setOnClickListener(new android.view.View.OnClickListener() {
            @Override
            public void onClick(android.view.View view) {
                int theCard = Integer.parseInt((String) view.getTag());
        ...
        iv_31.setOnClickListener(new android.view.View.OnClickListener() {
            @Override
            public void onClick(android.view.View view) {
                int theCard = Integer.parseInt((String) view.getTag());
        ...
        iv_32.setOnClickListener(new android.view.View.OnClickListener() {
            @Override
            public void onClick(android.view.View view) {
                int theCard = Integer.parseInt((String) view.getTag());
        ...
        iv_33.setOnClickListener(new android.view.View.OnClickListener() {
            @Override
            public void onClick(android.view.View view) {
                int theCard = Integer.parseInt((String) view.getTag());
        ...
        iv_34.setOnClickListener(new android.view.View.OnClickListener() {
            @Override
            public void onClick(android.view.View view) {
                int theCard = Integer.parseInt((String) view.getTag());
    ...
    private void checkEnd(){
        if(iv_11.getVisibility()==View.INVISIBLE &&
            ...
            AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(MindGames.this);
            alertDialogBuilder
                     ...
                     .setCancelable(false)
                      .setPositiveButton("NEW", new DialogInterface.OnClickListener() {
                          ...
                          public void onClick(DialogInterface dialogInterface, int i) {
                              Intent intent = new Intent(getApplicationContext(),MindGames.class);
